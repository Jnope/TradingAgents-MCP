...
DEFAULT_CONFIG = {
    ...
    "results_dir": os.getenv("TRADINGAGENTS_RESULTS_DIR", os.path.join(_TRADINGAGENTS_HOME, "results")),
    "data_dir": os.path.join(_TRADINGAGENTS_HOME, "data"),
    "data_cache_dir": os.path.join(_TRADINGAGENTS_HOME, "data_cache"),
    # LLM settings
    "llm_provider": "openai",
